...
Subscribe to my OnlyFans if you want to see the next installment: JUST FUCKING USE GOPHER! (not that Golang guy, this one: https://en.wikipedia.org/wiki/Gopher_(protocol), know the difference). And yes, of course this site only works through HTTPS. You wouldn't fuck without a condom on a first date either, would you?
